...
[![shipthatcode — C++ Fundamentals](https://api.shipthatcode.com/cert/8d53cc5101e0b9c85bdf33a697163ef9.svg)](https://shipthatcode.com/courses/cpp-fundamentals)
...
- a C++17 compiler — `g++` or `clang++` (macOS: `xcode-select --install`, Ubuntu: `sudo apt install build-essential`, Windows: MinGW or WSL). Single-file, standard library only — no external libraries, same as the grader
